<?php require_once __DIR__ . '/config.php'; ?>
  <footer class="site-footer">
    <div class="footer-wordmark" aria-hidden="true"><img src="assets/images/high-tide-footer.svg" alt=""></div>
    <div class="container">
      <div class="footer-centered">
        ...
        <p class="footer-address"><?= SITE_ADDRESS ?> &nbsp;&middot;&nbsp; <a href="mailto:<?= SITE_EMAIL ?>"><?= SITE_EMAIL ?></a></p>
        <div class="footer-bottom">
          <p>&copy; <?= SITE_YEAR ?> High Tide Technology LLC. All Rights Reserved.</p>
        </div>
      </div>
    </div>
  </footer>
